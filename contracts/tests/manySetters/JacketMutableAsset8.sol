 ...
 * it to mutate
 */
contract JacketMutableAsset8 is MutableAsset {
    /** */
    constructor(
        address _nmt,
...
function setMethod6(uint256 _param, string memory _tokenURI) public evaluatedByCreator(msg.sender,abi.encodeWithSignature("setMethod1(uint256, string)", _param, _tokenURI),address(this)) evaluatedByHolder(msg.sender,abi.encodeWithSignature("setMethod6(uint256, string)",_param, _tokenURI),address(this)){ _setMethod6(_param, _tokenURI);}function _setMethod6(uint256 _param, string memory _tokenURI) public { jacketDescriptor.method6 = _param; setTokenURI(_tokenURI);emit StateChanged(jacketDescriptor);}


function setMethod7(uint256 _param, string memory _tokenURI) public evaluatedByCreator(msg.sender,abi.encodeWithSignature("setMethod1(uint256, string)", _param, _tokenURI),address(this)) evaluatedByHolder(msg.sender,abi.encodeWithSignature("setMethod7(uint256, string)",_param, _tokenURI),address(this)){ _setMethod7(_param, _tokenURI);}function _setMethod7(uint256 _param, string memory _tokenURI) public { jacketDescriptor.method7 = _param; setTokenURI(_tokenURI);emit StateChanged(jacketDescriptor);}


function setMethod8(uint256 _param, string memory _tokenURI) public evaluatedByCreator(msg.sender,abi.encodeWithSignature("setMethod1(uint256, string)", _param, _tokenURI),address(this)) evaluatedByHolder(msg.sender,abi.encodeWithSignature("setMethod8(uint256, string)",_param, _tokenURI),address(this)){ _setMethod8(_param, _tokenURI);}function _setMethod8(uint256 _param, string memory _tokenURI) public { jacketDescriptor.method8 = _param; setTokenURI(_tokenURI);emit StateChanged(jacketDescriptor);}
